...
def Test(df, other, symbol):
    ...
    if series.loc[{index}].iloc[-1] is 0:
        ...
        private static TestCaseData[] TestDataFrameNonExceptionFunctions => _parameterlessFunctions["DataFrame"];

        private static TestCaseData[] TestSeriesNonExceptionFunctions => _parameterlessFunctions["Series"];
        ...
        private static TestCaseData[] TestDataFrameOtherParameterFunctions => _parameterlessFunctions["DataFrameOtherParameter"];

        private static TestCaseData[] TestSeriesOtherParameterFunctions => _parameterlessFunctions["SeriesOtherParameter"];
...
");
                ...
                functionsByType.Add("DataFrameOtherParameter", converter("DataFrameOtherParameter"));
                functionsByType.Add("SeriesOtherParameter", converter("SeriesOtherParameter"));
            }
